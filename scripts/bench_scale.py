...
from cns_py.demo.ingest import upsert_atom, link_with_validity
...
def setup_data():
    ...
    with get_conn() as conn:
        with conn.cursor() as cur:
            ...
            cur.executemany("INSERT INTO atoms (kind, label) VALUES (%s, %s) ON CONFLICT DO NOTHING", atom_args)
            ...
            cur.executemany("INSERT INTO fibers (src, dst, predicate) VALUES (%s, %s, %s)", fiber_args)
